...
// Check for DOM readiness before setting up the game
document.addEventListener('DOMContentLoaded', function() {
    ...
    var startButton = document.getElementById('startTournamentButton');
    if (startButton) {
        startButton.addEventListener('click', handleStartTournamentClick);
    } else {
